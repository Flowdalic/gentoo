...
USE_PHP="php8-2 php8-3 php8-4 php8-5" # deps must be registered separately below

POSTGRES_COMPAT=( 13 14 15 16 17 )

MY_P="${P/_/-}"

inherit lua-single multiprocessing pax-utils php-ext-source-r3
...
# v8: TODO
# matheval: TODO
IUSE="apache2 +caps debug +embedded expat json +pcre +routing selinux +ssl +xml yajl yaml zeromq"
...
CDEPEND="
	...
	php? (
		...
		php_targets_php8-5? ( dev-lang/php:8.5[embed] )
	)
	python? ( ${PYTHON_DEPS} )
