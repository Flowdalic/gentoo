...
# Using higher version like swt-4.35 would lead to compile error:
# import org.eclipse.swt.SWT;
#                       ^
#   bad class file: /usr/share/swt/lib/swt.jar(/org/eclipse/swt/SWT.class)
#     class file has wrong version 61.0, should be 55.0
RDEPEND="
	app-accessibility/at-spi2-core
	dev-java/swt:4.27[cairo,opengl]
	dev-libs/glib:2
	dev-libs/libxml2:2=
	dev-libs/libxslt
...
src_prepare() {
	...
	sed -i "s#__gentoo_swt_jar__#$(java-pkg_getjars swt-4.27)#" "${S}"/build.gradle || die
}
